	...
	<div class="container_inner">
		<h2 class="container_title">비밀번호 확인</h2>
			<form action="deletePro.jsp" method="post" name="fr">
				...
				<div class="input_div"><button class="input_button" type="button" onclick="return check();">확인</button><button class="input_button" type="button" onclick="location.href='locationInfo.jsp'">뒤로</button></div>
			</form>
		</div>
	</div>
